class Point {
    ...
    draw(context){
      ...
      context.font = "14px Calibri Light";
      ...
      context.fillText(this.char, this.position.dx - this.radius * 0.5, this.position.dy + this.radius * 1.6);
      context.strokeText(this.char, this.position.dx - this.radius * 0.5, this.position.dy + this.radius * 1.6);
